  ...
  return (
    <section className="container mx-auto my-5 bg-gradient-to-r from-indigo-200 from-10% via-sky-200 via-30% to-emerald-200 to-90% rounded-xl ">
      ...
      <div className="text-center px-2 lg:px-0" data-aos="fade-right">
        ...
        <p className="mt-6 px-2 lg:px-[370px]">
          Get in touch with us! Fill out the form below for personalized
      ...
      <div className="mt-8 lg:flex px-5" data-aos="fade-right">
        ...
        >
          <div
            className="bg-[#bced6e1a] rounded-xl py-8 pr-40 pl-6"
            data-aos="fade-right"
          >
            <img src={image1} alt="" />
          ...
          <div
            className="bg-[#fddb5f1a] rounded-xl py-8 pr-40 pl-6"
            data-aos="fade-right"
          >
            <img src={image2} alt="" />
          ...
          <div
            className="bg-[#629cf31a] rounded-xl py-8 pr-40 pl-6"
            data-aos="fade-right"
          >
            <img src={image3} alt="" />
        ...
        >
          ...
          <div className="px-10" data-aos="fade-right">
            <button
              type="submit"
              className="btn btn-primary w-full hover:bg-orange-950 bg-red-500 border-none text-xl font-bold"
            >
              Send Message
            </button>
          </div>
