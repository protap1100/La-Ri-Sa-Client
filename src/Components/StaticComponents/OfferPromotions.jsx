...
const OfferPromotions = () => {
  return (
    <div>
      <div className="h-40 md:w-5/6 w-full flex items-center lg:w-4/6 rounded-xl mx-auto bg-gradient-to-r from-blue-500 via-purple-100 to-indigo-500">
        <div className="flex bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  mx-auto md:gap-5 gap-2 px-3 rounded py-2 lg:gap-20 items-center justify-between">
          ...
          <div>
            <Link
              to="/allRoom"
              className="font-bold bg-black p-3 text-white gap-4 rounded"
            >
              Book Now
            </Link>
          </div>
      ...
      <div className="h-80 w-full md:w-full  flex lg:flex-row flex-col items-center lg:w-4/6 rounded-xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-blue-100 via-purple-300 to-indigo-400 py-12 rounded-xl">
